...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="relative flex flex-col justify-between px-6 sm:px-12 lg:px-20 py-32 sm:py-40 lg:py-56 bg-[#0A0A0A] border-t border-neutral-900 select-none"
    >
      <div>
        ...
        <div className="max-w-6xl mb-16 sm:mb-24">
          <h2 className="font-display text-[clamp(3.5rem,14vw,12rem)] font-black text-white tracking-tighter uppercase leading-none mb-6 sm:mb-8">
            LET'S TALK<span className="text-[#8B5CF6]">.</span>
          </h2>
          <p className="text-xl sm:text-2xl lg:text-3xl text-neutral-400 font-normal max-w-3xl leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 max-w-5xl">
          {/* Email Direct Link */}
          <div className="p-6 sm:p-8 rounded-2xl bg-[#141414] border border-neutral-800/80 hover:border-neutral-600 transition-colors duration-200 flex flex-col justify-between group">
          ...
          <a
            ...
            className="p-6 sm:p-8 rounded-2xl bg-[#141414] border border-neutral-800/80 hover:border-neutral-600 transition-colors duration-200 flex flex-col justify-between group"
          >
            <div className="flex justify-between items-start mb-6 sm:mb-8">
